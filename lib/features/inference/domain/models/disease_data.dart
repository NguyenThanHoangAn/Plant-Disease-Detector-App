...
class DiseaseDataRepository {
  static final Map<String, DiseaseInfo> _diseaseData = {
    'healthy': DiseaseInfo(
      plantName: const BilingualText('Cây', 'Plant'),
      diseaseName: const BilingualText('Khỏe mạnh', 'Healthy'),
      description: const BilingualText(
    ...
    'early_blight': DiseaseInfo(
      plantName: const BilingualText('Cà chua', 'Tomato'),
      diseaseName: const BilingualText('Mốc sớm', 'Early Blight'),
      description: const BilingualText(
    ...
    'late_blight': DiseaseInfo(
      plantName: const BilingualText('Cà chua', 'Tomato'),
      diseaseName: const BilingualText('Mốc muộn', 'Late Blight'),
      description: const BilingualText(
    ...
    'septoria_leaf_spot': DiseaseInfo(
      plantName: const BilingualText('Cà chua', 'Tomato'),
      diseaseName: const BilingualText('Đốm lá Septoria', 'Septoria Leaf Spot'),
      description: const BilingualText(
    ...
    'bacterial_spot': DiseaseInfo(
      plantName: const BilingualText('Cà chua', 'Tomato'),
      diseaseName: const BilingualText('Đốm vi khuẩn', 'Bacterial Spot'),
      description: const BilingualText(
    ...
    'leaf_mold': DiseaseInfo(
      plantName: const BilingualText('Cà chua', 'Tomato'),
      diseaseName: const BilingualText('Nấm lá', 'Leaf Mold'),
      description: const BilingualText(
    ...
    'target_spot': DiseaseInfo(
      plantName: const BilingualText('Cà chua', 'Tomato'),
      diseaseName: const BilingualText('Đốm bia', 'Target Spot'),
      description: const BilingualText(
    ...
    'mosaic_virus': DiseaseInfo(
      plantName: const BilingualText('Cà chua', 'Tomato'),
      diseaseName: const BilingualText('Virus khảm', 'Mosaic Virus'),
      description: const BilingualText(
    ...
    'yellow_leaf_curl': DiseaseInfo(
      plantName: const BilingualText('Cà chua', 'Tomato'),
      diseaseName: const BilingualText('Cuốn lá vàng', 'Yellow Leaf Curl'),
      description: const BilingualText(
    ...
    'scab': DiseaseInfo(
      plantName: const BilingualText('Táo', 'Apple'),
      diseaseName: const BilingualText('Đốm sẹo', 'Scab'),
      description: const BilingualText(
    ...
    'black_rot': DiseaseInfo(
      plantName: const BilingualText('Nho', 'Grape'),
      diseaseName: const BilingualText('Thối đen', 'Black Rot'),
      description: const BilingualText(
    ...
    'rust': DiseaseInfo(
      plantName: const BilingualText('Cây', 'Plant'),
      diseaseName: const BilingualText('Gỉ sắt', 'Rust'),
      description: const BilingualText(
    ...
    'esca': DiseaseInfo(
      plantName: const BilingualText('Nho', 'Grape'),
      diseaseName: const BilingualText('Esca', 'Esca'),
      description: const BilingualText(
    ...
    'blight': DiseaseInfo(
      plantName: const BilingualText('Cây', 'Plant'),
      diseaseName: const BilingualText('Héo úa', 'Blight'),
      description: const BilingualText(
    ...
    'cercospora_leaf_spot': DiseaseInfo(
      plantName: const BilingualText('Cây', 'Plant'),
      diseaseName: const BilingualText('Đốm lá Cercospora', 'Cercospora Leaf Spot'),
      description: const BilingualText(
